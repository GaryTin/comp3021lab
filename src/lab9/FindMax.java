...
public class FindMax {
	...
	int start_index,end_index,max=array[0];
	class findMax_task implements Runnable
	{
		int start_index,end_index;
		public findMax_task(int s,int e)
		{
			start_index = s;
			end_index = e;
		}
		...
		public void run(){
            //things to do    
			output.add(findMax(start_index,end_index));
		}
		
	}
	public void runThread(){
		start_index = 0; end_index = 29;
		Thread t1 = new Thread(new findMax_task(0,29));
		t1.start();
		start_index = 30; end_index = 59;
		Thread t2 = new Thread(new findMax_task(30,59));
		t2.start();
		start_index = 60; end_index = 89;
		Thread t3 = new Thread(new findMax_task(60,89));
		t3.start();
