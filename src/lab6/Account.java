...
public class Account {
	...
	public static Predicate<Account> checkBound = a -> a.lowerBound.and(upperBound).test(a);
	...
	// TODO: Task3 
	// replace the null with a lambda expression
	public static AddMaker maker = n -> (ac) -> { ac.balance += n;};
	...
	public static int getMaxAccountID(List<Account> accounts) {
		// TODO: Task4 
		// replace the null with a lambda expression
		Account maxOne = accounts.stream().reduce(new Account(0, -100), (ac,max)-> ac.balance>max.balance ? ac:max);
